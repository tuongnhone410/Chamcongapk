      ...
      <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <AlertDialog>
            ...
            <AlertDialogContent className="bg-zinc-950 border-zinc-800 text-white rounded-[2rem] z-[110] max-h-[90vh] overflow-y-auto w-[95vw] max-w-md p-6">
              <AlertDialogHeader>
                ...
                <AlertDialogDescription className="text-zinc-400 font-bold">
                  Hành động này sẽ xóa tất cả phiên làm việc của tháng hiện tại. Bạn sẽ có 10 giây để nhấn nút KHÔI PHỤC trước khi dữ liệu bị xóa vĩnh viễn.
                </AlertDialogDescription>
              </AlertDialogHeader>
          ...
          <Dialog open={showMultiDialog} onOpenChange={setShowMultiDialog}>
            ...
            <DialogContent className="sm:max-w-[425px] bg-zinc-950 border-zinc-800 text-white rounded-[2rem] max-h-[90vh] overflow-y-auto z-[110] w-[95vw] max-w-md p-6">
              <DialogHeader>
              ...
              <DialogFooter className="gap-2 mt-4">
                <Button onClick={handleMultiAdd} disabled={isProcessing} className="bg-primary hover:bg-primary/90 text-black rounded-xl h-14 font-black shadow-xl w-full text-lg">
                  LƯU DỮ LIỆU
                </Button>
              </DialogFooter>
            </DialogContent>
          ...
          <Dialog open={showBatchDialog} onOpenChange={setShowBatchDialog}>
            ...
            <DialogContent className="sm:max-w-[425px] bg-zinc-950 border-zinc-800 text-white rounded-[2rem] z-[110] max-h-[90vh] overflow-y-auto w-[95vw] max-w-md p-6">
              <DialogHeader>
              ...
              <DialogFooter className="mt-4">
                <Button onClick={handleBatchAdd} disabled={isProcessing} className="bg-primary hover:bg-primary/95 text-black rounded-xl h-14 font-black shadow-xl w-full text-lg">
                  ĐỒNG BỘ NGAY
                </Button>
              </DialogFooter>
            </DialogContent>
      ...
      {editingSession && (
        <Dialog open={!!editingSession} onOpenChange={(open) => !open && setEditingSession(null)}>
          <DialogContent className="bg-zinc-950 border-zinc-800 text-white rounded-[2rem] z-[110] max-h-[90vh] overflow-y-auto w-[95vw] max-w-md p-6">
            ...
            <DialogFooter className="mt-4">
              <Button onClick={handleUpdate} disabled={isProcessing} className="bg-primary hover:bg-primary/90 text-black rounded-xl h-14 font-black shadow-xl w-full text-lg">
                {isProcessing ? (
                  <>
